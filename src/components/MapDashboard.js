...
import MapPoly from "./Map/MapPoly";
import MapForm from "./MapForm";
import * as api from "../api";
import * as ENV_VARS from "../global/env";
import MapPolyContainer from "./Map/MapPolyContainer";
import Table from "./Table/Table";
import MapContainer from "./Map/MapContainer";
import { generateDateOptions } from "./Utilities/Utilities";
import { arrayIsValid, has, SpliceObjArray } from "./Utilities/ObjectUtils";
...
function MapDashboard ( props )
{
    ...
    const [dates, setDates] = useState(generateDateOptions());
        ...
        <>
            <Sidebar
                ...
                <div className="flex-panel">
                    ...
                    {arrayIsValid(selectedAreas, true) && (
                        <div className="flex-panel-element">
                            <div>
                    ...
                    {query && mapDatatype && (
                        <Tabs
                            ...
                            <div
                                ...
                                {!isFetching &&
                                    showTable &&
                                    !arrayIsValid(searchResults, true) && (
                                        <Table
                                            isVisible={showTable}
                                            isFetching={isFetching}
